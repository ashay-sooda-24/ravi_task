...
const Products = (props) => {
  ...
  function search(e) {
    ...
    if (e.target.value !== "") {
      products.map((item)=>{
        if(item.mobile.toLowerCase() === input.toLowerCase()){
          console.log("it's equal inside")
          console.log(item);
          setSearchedItem([...searchedItem, item])
  ...
  function addToCart() {
    searchedItem.map((items)=>{
      // if(items.select === true){
        props.cartItems([...props.cartItem,items.mobile])
      // }

    })
      // props.cartItems(searchedItem.mobile)
    //  <CartContainer items={searchedItem} />
